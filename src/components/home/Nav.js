    ...
    <div className="navigation">
      <div className="container">
        <div className="navigation-flex">
          <Link to="/"><h4><span className="text-colored">Begench</span></h4></Link>
            ...
            <div className="navigation--menu">
              <nav className={isOpen ? "nav active" : "nav"}>
                ...
                <div id="primary-navigation" className="links">
                    ...
                    <a href="/#contact" onClick={setToggle}>Contact Me</a>
                </div>
                {/* Primary Social Links */}
                <div className="social">
                  <a href="https://www.linkedin.com/in/begenchs/" target="_blank" rel="noopener noreferrer"><img src={linkedin} alt="linkedin logo" className="icon linkedin"/></a>
                  <a href="https://github.com/begenchs" target="_blank" rel="noopener noreferrer"><img src={github} alt="github logo" className="icon github"/></a>
                </div>
              </nav>
